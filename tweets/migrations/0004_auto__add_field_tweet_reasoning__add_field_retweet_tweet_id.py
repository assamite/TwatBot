...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.reasoning'
        db.add_column(u'tweets_tweet', 'reasoning',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'ReTweet.tweet_id'
        db.add_column(u'tweets_retweet', 'tweet_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.reasoning'
        db.delete_column(u'tweets_tweet', 'reasoning')

        # Deleting field 'ReTweet.tweet_id'
        db.delete_column(u'tweets_retweet', 'tweet_id')
    ...
    models = {
        ...
        u'tweets.tweet': {
            ...
            'reasoning': ('django.db.models.fields.TextField', [], {'default': "''"}),
