...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tweets_retweet', (
            ...
            ('retweeted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('tweet_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('screen_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('tweet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tweets.Tweet'])),
        ))
        db.send_create_signal(u'tweets', ['ReTweet'])


    def backwards(self, orm):
        # Deleting model 'ReTweet'
        db.delete_table(u'tweets_retweet')
